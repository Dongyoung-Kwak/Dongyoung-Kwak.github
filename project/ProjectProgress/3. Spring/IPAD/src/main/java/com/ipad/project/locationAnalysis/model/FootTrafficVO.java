...
public class FootTrafficVO {
	...
	public FootTrafficVO(String adm_cd, String quater, String population_total, String population_mon,
	...
	public String toString() {
		return "FootTrafficVO [adm_cd=" + adm_cd + ", quater=" + quater + ", population_total=" + population_total
				+ ", population_mon=" + population_mon + ", population_tues=" + population_tues + ", population_wed="
				+ population_wed + ", population_thur=" + population_thur + ", population_fri=" + population_fri
				+ ", population_sat=" + population_sat + ", population_sun=" + population_sun + ", region_name_detail="
				+ region_name_detail + "]";
	}
