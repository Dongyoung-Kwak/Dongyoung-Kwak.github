            ...
            <table>
                <div class="col-12">
                    ...
                    <tr id="qWriteTable">
                        ...
                        <td><input type="text" name="subject" required id="inputType"></td>
                    </tr>
                    <tr id="qWriteTable">
                     ...
                     <tr id="qWriteTable">
                        ...
                        <td><input type="password" name="password" required id="inputType"></td>
                    </tr>
                    <tr id="qWriteTable">
                        <td id="qWriteTableName">글내용</td>
                        <td><textarea placeholder="내용을 입력해주세요" required name="content"></textarea></td>
                    </tr>
                </div>
            </table>
        </div>
